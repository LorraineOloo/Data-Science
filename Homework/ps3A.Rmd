...
> ANSWER:       
1.If I make internal changes in RStudio after publishing it, does Shiny app update automatically in the server?          
2.It wasn't very clear to me how I can combine a CSS file and a Shiny app.     
