...
> ANSWER: 
A histogram. The distribution is multimodal. The minimum length of term served in the supreme court is ~0.4 years, and the maximum length is ~36.5. The median is 15.3, lower quartile is ~7.0, and the upper quartile is 23.5. The mean is 16.06 and the standard deviation is 9.91.
