...
> ANSWER: Mary Decker, 4hours, 20minutes, and 5seconds
...
> ANSWER: 4hours,12min,33sec, Sifan Hassan,	Netherlands, 12July2019, Monaco,	outdoor

```{r}
women_outdoor <- html_table(tables[[8]])
women_outdoor <- select(women_outdoor, -Auto)
women_outdoor
```

```{r}
women_indoor$Type <- c("indoor")
women_outdoor$Type<- c("outdoor")
